...
viewport={{once:true}}
       className='inline-flex items-center gap-2 border border-gray-300 p-1.5 pr-4
      rounded-full'>
...
Turning imagination into <span className=' inline-block bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent'>
...
viewport={{once:true}}
 className='text-sm sm:text-lg  font-medium text-gray-500 dark:text-white'>Creating meaningful connections and turning big ideas into interactive 
