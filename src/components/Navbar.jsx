...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    ...
    className="flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70 relative ">
      ...
      <div className={` absolute left-[64%] -translate-x-1/2  text-gray-700 dark:text-white sm:text-sm
      ...
      transition-all`}>
        ...
        <a  onClick={() => setSidebarOpen(false)  } href="#" className="hover:border-b">Home</a>
